...
## Поддержка автора
Оказать поддержку или задать вопрос автору лично можно через игровую почту STALZONE по нику: Kwokwiy
...
Рекомендуется опубликовать в репозитории обезличенную копию ответа поддержки, скрыв персональные данные и номер аккаунта.
...
- красная, зелёная, оранжевая, фиолетовая, розовая и голубая цветовые палитры;
- сохранение темы и цвета после перезапуска.
